...
|#|Name|Done|
|-|----|---|
|1|存入 100 CPC，需失败，因为没有矿工
|2|初始化 3 个矿工，用户存入 0 CPC，需失败，下限
|3|初始化 3 个矿工，存入 100 CPC，获取其合约中的 Balance，结果为 100 CPC，根据事件获取指定的矿工，获取其余额及其合约 Balance，均需增加了 100 CPC，其余两个需不变，校验用户总 Balane
|4|初始化 3 个矿工，存入 1000000 CPC，需失败，超了上限
...
|16|初始化 3 个矿工，存入 100 CPC，取出 100 CPC，成功
|17|初始化 3 个矿工，存入 100 CPC，取出 1 CPC，成功
